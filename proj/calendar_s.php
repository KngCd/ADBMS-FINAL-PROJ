...
<body class="bg-light">
    ...
    <?php
        ...
        $schedules = $con->query("SELECT * FROM tbl_events2 WHERE student_id = $id");
        $sched_res = [];
                ...
                <div class="cardt rounded-0 shadow">
                    ...
                    <div class="card-footer">
                        <div class="text-center">
                            ...
                            <button class="btn btn-primary btn-sm rounded-0 back" style="background-color: #0c3666; border-color:#0c3666;" type="submit" form="schedule-form" onclick="location.href='SHome.php'">Go Back</button>
                        </div>
                    </div>
                </div>
            </div>
